<template>
  <div class="col p-3" style="height: 30vh; background-color: rgb(226, 226, 226);">
    {{selectedPosts}}
    <div>
      <button @click="like(selectedPosts._id)" class="btn btn-primary">click to like</button>
      <button @click="deletePost(selectedPosts._id)" class="btn btn-danger">click to delete</button>
    </div>
